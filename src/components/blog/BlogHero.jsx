...
const BlogHero = () => {
  ...
  return (
    <section className="h-[400px] bg-[#2e6a4f] relative overflow-hidden flex items-center px-12">
      ...
      <div ref={sectionRef} className="max-w-[1280px] mx-auto w-full z-10 animate">
        <div className="flex items-center gap-4 mb-4">
          ...
          <span className="font-label text-xs tracking-[0.2em] uppercase text-white/60">
            Insights & Reflections
          </span>
        </div>
        <h1 className="font-mercury text-7xl md:text-[96px] leading-[0.9] text-white tracking-tighter">
          Words That <br /> <span className="italic font-light">Heal & Inspire</span>
        </h1>
        <p className="font-label font-light text-[18px] text-white/70 mt-6 max-w-xl">
