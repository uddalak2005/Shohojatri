      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 w-full max-w-[1280px] mx-auto z-10 relative">
        ...
        <div>
          ...
          <p className="font-label text-sm text-white/70 leading-relaxed">
            ...
            Peaceful Enclave, Dhaka.<br /><br />
            hello@shohojatri.org
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 font-label text-sm text-white/70">
            <a className="hover:text-[#9ae600] transition-all" href="https://instagram.com" target="_blank" rel="noopener noreferrer">Instagram</a>
            <a className="hover:text-[#9ae600] transition-all" href="https://linkedin.com" target="_blank" rel="noopener noreferrer">LinkedIn</a>
          </div>
        </div>
      </div>
