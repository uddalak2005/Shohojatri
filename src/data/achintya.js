...
export const achintyaPathways = [
  { id: 1, icon: 'theater_comedy', title: 'Performance Bookings', desc: 'Curated artistic performances designed for awareness campaigns and corporate wellness.' },
  { id: 2, icon: 'school', title: 'Workshop Programs', desc: 'Intensive skill-based workshops blending art techniques with psychological wellbeing.' },
  { id: 3, icon: 'psychology', title: 'Expressive Arts', desc: 'One-on-one sessions utilizing creative mediums to explore personal narratives and trauma.' },
  { id: 4, icon: 'groups', title: 'Outreach', desc: 'Community-led initiatives bringing the healing power of art to marginalized populations.' }
];

export const achintyaGalleryStrip = [
...
export const achintyaTestimonials = [
  { id: 1, quote: '"Through Achintya, I found the colors for the grief I couldn\'t speak. It saved me from the noise of my own mind."', name: 'Aditi S.', role: 'Artist & Educator' },
  { id: 2, quote: '"The somatic movement sessions were a revelation. I never knew my body held so many stories waiting to be danced."', name: 'Rahul K.', role: 'Psychologist' },
  { id: 3, quote: '"A sanctuary for the soul. Achintya doesn\'t just teach art; it teaches you how to feel again."', name: 'Sreemoyee M.', role: 'Corporate Consultant' }
];
