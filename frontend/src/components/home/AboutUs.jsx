...
const ABOUT_VIDEO_URL = 'https://cdn.sanity.io/files/cbinx0cl/production/e342321680beadfc094c652f25ab8428c766c4f5.mp4';
...
// ── About Video Frame ───────────────────────────────────────────────────────
const AboutVideoFrame = ({ videoUrl }) => {
...
// ── About Us Section ────────────────────────────────────────────────────────
const AboutUs = ({ data, videoUrl }) => {
  const sectionRef = useScrollAnimation();
  const displayData = data || aboutData;
  const displayVideoUrl = videoUrl || ABOUT_VIDEO_URL;
      ...
      >
        ...
        <div ref={sectionRef} className="animate lg:col-span-7 space-y-8">
          <SectionHeader
            ...
            titleLine1={displayData.titleLine1}
            titleLine2={displayData.titleLine2}
            italic={2}
          />

          <div className="space-y-5 max-w-xl">
            {displayData.paragraphs.map((p, i) => (
              <p
                key={i}
        ...
        <div className="lg:col-span-5">
          <AboutVideoFrame videoUrl={displayVideoUrl} />
        </div>
